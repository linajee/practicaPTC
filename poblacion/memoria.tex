...
\begin{enumerate}[leftmargin=*,itemsep=0.4em,topsep=0.2em]
    ...
    Sí. \texttt{numpy.array} se usa extensivamente para: almacenar datos del CSV, operaciones vectorizadas de variaciones, manipulación de matrices (\texttt{hstack}, \texttt{vstack}), agregaciones (\texttt{mean}, \texttt{argsort}) y transformaciones entre provincias y CCAA.
